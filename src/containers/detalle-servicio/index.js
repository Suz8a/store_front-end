...
const data=[{MaterialAdjunto: "Plata", Peso: "80gr"},{MaterialAdjunto: "Oro", Peso: "95gr"}];
const data1=[{MaterialAUtilizar: "Plata", Peso: "80gr"},{MaterialAUtilizar: "Oro", Peso: "95gr"}];
    ...
    return (
        <Form>
            <div style={{ padding: "50px 100px" }}>
                ...
                <div style={{ marginTop: "40px" }}>
                    <ClientService name="Suzclem Adriana Ochoa" product="Pulsera" weight="90"/>
                </div>
                <div style={{ marginTop: "40px" }}>
