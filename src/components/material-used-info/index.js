                ...
                <Typography variant = "h6" component = "h2"> Material a Utilizar </Typography>
                    <Grid container direction = "row" justify = "flex-start" alignItems = "flex-start">
                        <Grid  item  direction="row"  justify="flex-start"  alignItems="center" style = {{paddingRight: "15px"}}>
                            <TextField label = "Oro (gr)" type= "number" style = {{paddingRight: "15px"}}/>
                            <Input placeholder="$1000" type= "number" style = {{width: 70 ,paddingTop: "16px"}}/>
                        </Grid>
                        <Grid  item  direction="row"  justify="flex-start"  alignItems="center" style = {{paddingRight: "15px"}}>
                            <TextField label = "Bronce (gr)" type= "number"style = {{paddingRight: "15px"}}/>
                            <Input placeholder="$1000" type= "number" style = {{width: 70 ,paddingTop: "16px"}}/>
                        </Grid>
                    </Grid>
                    <Grid container direction = "row" justify = "flex-start" alignItems = "flex-start">
                        <Grid  item  direction="row"  justify="flex-start"  alignItems="center" style = {{paddingRight: "15px"}}>
                            <TextField label = "Plata (gr)" type= "number" style = {{paddingRight: "15px"}}/>
                            <Input placeholder="$1000" type= "number" style = {{width: 70 ,paddingTop: "16px"}}/>
                        </Grid>    
                        <Grid  item  direction="row"  justify="flex-start"  alignItems="center" style = {{paddingRight: "15px"}}>
                            <TextField label = "Acero Inoxidable (gr)" type= "number"style = {{paddingRight: "15px" }}/>
                            <Input placeholder="$1000" type= "number" style = {{width: 70 ,paddingTop: "16px"}}/> 
                        </Grid>
                    </Grid>
            </Grid >
